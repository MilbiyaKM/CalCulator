...
public class CalculationActivity extends AppCompatActivity {
    ...
    Button button0,button1,button2,button3,button4,button5,button6,button7,button8,button9,buttonAdd,
            buttonSub,buttonMul,buttonDiv,buttonEqual,buttonDEl,buttonDott,Remainder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDott=(Button) findViewById(R.id.buttonDot);
        Remainder=(Button) findViewById(R.id.buttonRewmainder);
        ...
        buttonDott.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(decimal){
